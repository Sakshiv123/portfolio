  ...
  return (
    <section id="projects" className="py-10 text-white">
      <div className="text-center px-4">
        ...
        <p className="text-gray-400 mt-2 text-base md:text-lg">My awesome works</p>
      </div>

      <div className="mt-10 px-4 sm:px-6 lg:px-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {projects.map((project_info, i) => (
            <div key={i} className="bg-slate-700 rounded-xl overflow-hidden shadow-md">
              <img
              ...
              <div className="p-4">
                ...
                <div className="flex flex-wrap gap-3">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-sm md:text-base primary-color bg-gray-800 px-3 py-1 rounded-md hover:opacity-90 transition"
                  >
                    GitHub
                  </a>
                  <a
